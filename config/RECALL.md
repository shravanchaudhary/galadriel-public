...
| Planning or checking today's intended work | `state/plan/<today>.md` |
| Reporting completed work or blockers | The operational source of truth plus `state/progress/<today>.md` |
