...
def morning_prompt(today: str) -> str:
    return (
        ...
        "(`palace_search` for the `daily-recap` drawer / room=conversations) before "
...
def goodnight_prompt(today: str) -> str:
    return (
        ...
        "/ today's daily log). If something you sent or finished isn't in that "
        ...
        "`palace_add_drawer` with topic `daily-recap-YYYY-MM-DD` (this is where "
