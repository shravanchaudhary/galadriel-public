...
def reflection_prompt(today: str) -> str:
    return (
        ...
        "palace_diary_write for a reflection in your own voice. Read "
        "knowledge/skills/experiential-reflection.md and use experience_report "
        "for an independent metacognitive appraisal of the one shared state. "
        "When an outcome forms a durable experiential episode, file its event, "
        "prior state, state change, decision, consequence, and lesson in "
        "room=episodes.\n\n"
        "PART 2 — Retro (learn from what you did) & Recall Tuning: Review your recent work via "
