...
WORKER_PROMPT = (
    ...
    "instead. This is a standalone HTML document: follow state/progress/README.md, "
    "preserve its doctype/head/styles and every existing entry, insert semantic content "
    "without scripts/forms/external assets, and leave valid DOM after every write.\n\n"
...
def morning_prompt(today: str) -> str:
    return (
        ...
        "`state/plan/README.md`: no scripts, forms, or external dependencies. If it "
        "already exists (e.g. you're re-running today's planning), read_file it first, "
        "preserve the document shell/styles and prior content, and amend the valid DOM "
...
def reflection_prompt(today: str) -> str:
    return (
        ...
        "document shell/styles and all prior entries, and leave valid DOM. "
        "Then:\n"
